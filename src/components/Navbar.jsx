...
<div className="navbar bg-[#15803D] text-white shadow-sm px-8">
  ...
  <div className="navbar-center border-2 border-blue-900 flex">
  ...
  <div className="navbar-end">
    <button className="btn rounded-full bg-amber-400 hover:bg-amber-600 text-green-700 border-0 active:scale-95">Plant a Tree</button>
  </div>
</div>
